...
public class BinaryTree
{
    ...
    */
    private static int height(Node n)
    {
        if(n == null)
            ...
            /*
            if(BinaryTree.height(n.left) >= BinaryTree.height(n.right))
                return 1 + BinaryTree.height(n.left);
            else
                return 1 + BinaryTree.height(n.right);*/
            //or
    ...
    */
    ...
    { 
        ...
        return subtree;
         */
        return new BinaryTree(this.root.left.data);
    }
    ...
    */
    ...
    { 
        return new BinaryTree(this.root.right.data);
    }
}
